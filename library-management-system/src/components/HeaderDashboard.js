    ...
    return (
        <div className='w-full flex justify-between p-2 items-center '>
           ...
           <div className='flex justify-center items-center  gap-4 border p-2 rounded-full bg-[#3B3B41]'>
            ...
            <label className='text-white px-4 font-semibold'>{JSON.stringify(hideSidebar)} Library Management System</label>
          
          
           </div>
           <div className='flex justify-center items-center   '>
            <input className='rounded-full h-[5vh] p-2' placeholder='Search...' type='search'></input>
           </div>

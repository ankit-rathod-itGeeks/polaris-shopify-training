...
function StudentsHome() {
  ...
  return (
   ...
   <div className="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">{issuedCount}</div>
   </div>
   ...
   <div>
       <div className="mb-2 text-xl font-bold tracking-tight text-gray-900 dark:text-white">Books Returned</div>
   <div className="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">sss</div>
   </div>
   ...
   <div>
       <div className="mb-2 text-xl font-bold tracking-tight text-gray-900 dark:text-white">Penalty</div>
   <div className="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">Rs.- aaa</div>
   </div>
